...
class DefeaturingWB ( Workbench ):
    ...
    def Initialize(self):
        ...
        self.appendToolbar("Defeaturing Tools", ["DefeaturingTools","DF_SelectLoop","refineFeatureTool","DefeatShapeFeature","ResetPosition"])
